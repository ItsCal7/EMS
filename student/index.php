...
?>
    ...
    <head>
        ...
        <title>Dashboard - EMS Student</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">View All Courses</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">View Personal Details</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href='javascript:;' onclick='toggleData("P");'>View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Register for Course</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
						...
						<div class="card mb-4 d-md-none" id="personalTable">
                            <div class="card-header" id="dataDisplay">
                                <i class="fas fa-table me-1"></i>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
										...
										while($row_product = $result_product->fetch_assoc())
										{
											$name = explode($row_product["stu_name"], " ");
											$first = substr($name[0], 0, 3);
											$last = $name[1];
											$name = $last . $first;
											if ($name == $_SESSION["id"])
											{
									?>
												<tr>
													...
													<td> <?php echo $row_product["stu_major"].$row_product["course_id"]?> </td>
